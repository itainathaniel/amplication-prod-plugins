...
import { clientDirectories, DTOs, EntityActionsMap, ModuleActionsAndDtosMap, ModuleMap, serverDirectories } from "./code-gen-types";
...
export type PluginAfterEvent<T extends EventParams> = (dsgContext: DsgContext, eventParams: T, modules: ModuleMap) => Promisable<ModuleMap>;
