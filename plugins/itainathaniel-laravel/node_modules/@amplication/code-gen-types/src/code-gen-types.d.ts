...
export declare enum EnumModuleDtoDecoratorType {
    ObjectType = "ObjectType",
    InputType = "InputType",
    ArgsType = "ArgsType"
}
export type ServiceSettings = Omit<BlockOmittedFields<models.ServiceSettings>, "id">;
export type AppInfo = {
    name: string;
    description: string;
    version: string;
...
export type Role = Omit<models.ResourceRole, "__typename" | "id" | "createdAt" | "updatedAt">;
export type EntityPermissionRole = Omit<models.EntityPermissionRole, "__typename" | "id" | "entityVersionId" | "action" | "entityPermission" | "resourceRoleId" | "resourceRole"> & {
    resourceRole: Role;
};
export type EntityPermissionField = Omit<models.EntityPermissionField, "__typename" | "id" | "permissionId" | "permission" | "fieldPermanentId" | "field" | "entityVersionId" | "permissionRoles"> & {
    field: EntityField;
    permissionRoles: EntityPermissionRole[] | null;
};
export type EntityPermission = Omit<models.EntityPermission, "__typename" | "id" | "entityVersionId" | "entityVersion" | "permissionRoles" | "permissionFields"> & {
    permissionRoles: EntityPermissionRole[];
    permissionFields: EntityPermissionField[];
};
export type EntityField = Omit<models.EntityField, "__typename" | "createdAt" | "updatedAt" | "position" | "dataType"> & {
    dataType: models.EnumDataType;
};
export type LookupResolvedProperties = Lookup & {
    relatedEntity: Entity;
    relatedField: EntityField;
    isOneToOneWithoutForeignKey?: boolean;
};
...
export type EntityMultiSelectOptionSetField = Omit<EntityField, "properties"> & {
...
export type ModuleAction = Omit<BlockOmittedFields<models.ModuleAction>, "id" | "actionType" | "restVerb" | "gqlOperation" | "inputType" | "outputType" | "restInputSource"> & {
    id?: string;
    displayName: string;
    description: string;
...
export type ModuleDtoProperty = Omit<models.ModuleDtoProperty, "propertyTypes"> & {
    propertyTypes: PropertyTypeDef[];
};
export type ModuleDto = Omit<BlockOmittedFields<models.ModuleDto>, "id" | "dtoType" | "properties"> & {
    id?: string;
    description: string;
...
export type ModuleActionDefaultTypesNestedOnly = Extract<models.EnumModuleActionType, models.EnumModuleActionType.ChildrenConnect | models.EnumModuleActionType.ChildrenDisconnect | models.EnumModuleActionType.ChildrenFind | models.EnumModuleActionType.ChildrenUpdate | models.EnumModuleActionType.ParentGet>;
export type ModuleActionDefaultTypesWithoutNested = Exclude<models.EnumModuleActionType, ModuleActionDefaultTypesNestedOnly | models.EnumModuleActionType.Custom>;
...
type defaultDtoTypes = Exclude<models.EnumModuleDtoType, models.EnumModuleDtoType.Custom | models.EnumModuleDtoType.CustomEnum | models.EnumModuleDtoType.Enum | models.EnumModuleDtoType.CreateNestedManyInput | models.EnumModuleDtoType.UpdateNestedManyInput>;
type defaultDtoNestedTypes = Extract<models.EnumModuleDtoType, models.EnumModuleDtoType.CreateNestedManyInput | models.EnumModuleDtoType.UpdateNestedManyInput>;
...
export type entityActions = {
    ...
    relatedFieldsDefaultActions: Record<string, //field name
    entityRelatedFieldDefaultActions>;
    customActions: ModuleAction[];
};
export type EntityActionsMap = Record<string, //module name/ entity name
entityActions>;
...
export type ModuleActionsAndDtosMap = Record<string, //module name
ModuleActionsAndDtos>;
type BlockOmittedFields<T> = Omit<T, "__typename" | "createdAt" | "updatedAt" | "parentBlock" | "displayName" | "description" | "blockType" | "versionNumber" | "inputParameters" | "outputParameters" | "lockedByUserId" | "lockedAt" | "lockedByUser">;
...
export type ServiceTopics = Omit<BlockOmittedFields<models.ServiceTopics>, "patterns"> & {
    patterns: Array<models.MessagePattern & {
        topicName?: string;
    }>;
};
