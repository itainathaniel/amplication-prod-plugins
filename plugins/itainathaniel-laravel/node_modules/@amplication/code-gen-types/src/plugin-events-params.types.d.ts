...
import { DTOs, Entity, EntityComponents, EntityField, EntityLookupField, EnumDataType, ModuleMap, NamedClassDeclaration, entityActions, ModuleContainer, ModuleAction } from "./code-gen-types";
...
export type CreateSchemaFieldHandler = (field: EntityField, entity: Entity, fieldNamesCount?: Record<string, number>) => CreateSchemaFieldResult;
