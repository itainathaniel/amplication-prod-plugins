...
class BlueprintPluginTemplatePlugin {
    ...
    async beforeCreateBlueprint(context, eventParams) {
        ...
        const stringReplacements = {
            PluginName: constants_1.REPLACEMENTS.PLUGIN_CAMEL_CASE_NAME,
        };
        ...
        const files = await context.utils.importStaticFilesWithReplacements(staticPath, ".", constants_1.REPLACEMENTS, stringReplacements);
        for (const file of files.getAll()) {
            const codeBlock = {
                path: (0, path_1.join)(basePluginPath, context.utils.replacePlaceholders(file.path, constants_1.REPLACEMENTS)),
...
exports["default"] = BlueprintPluginTemplatePlugin;
