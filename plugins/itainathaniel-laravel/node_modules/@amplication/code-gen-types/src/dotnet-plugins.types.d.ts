...
import { clientDirectories, DTOs, EntityActionsMap, ModuleActionsAndDtosMap, serverDirectories } from "./code-gen-types";
...
export type PluginBeforeEvent<T extends EventParams> = (dsgContext: DsgContext, eventParams: T) => Promisable<T>;
export type PluginAfterEvent<T extends EventParams, F extends AstNode> = (dsgContext: DsgContext, eventParams: T, files: FileMap<F>) => Promisable<FileMap<F>>;
export interface PluginEventType<T extends EventParams, F extends AstNode = Class> {
...
export declare enum DotnetEventNames {
